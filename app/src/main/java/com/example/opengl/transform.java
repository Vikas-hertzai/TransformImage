...
public class transform {
    ...
    public void run(float[] mvpMatrix, String image, String triangulation, String reference_points, String warped_points, String background_image) throws FileNotFoundException {
...
//        int  n = wrp_pts.size() / ref_pts.size();    // number of frame
        int n = 50;  // testing with lesser number
        int  i = 0;
        ...
        while (i < n)
        {
            ...
            GLES20.glDrawElements(GLES20.GL_TRIANGLE_STRIP, tri_idx.size(), GLES20.GL_UNSIGNED_SHORT, index); // to draw
